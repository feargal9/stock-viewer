...
const StatsIcon = (): JSX.Element => (
  <Box color="background">
    <Icon size={26} icon={statsDots} />
  </Box>
);
const ThemeToggleIcon = (): JSX.Element => (
  <Box color="background">
    <Icon size={12} icon={redo} />
  </Box>
);
    ...
    <Flex flexDirection="row" bg="text">
      <Box as="header" width={1} p={2} sx={{ height: '50px' }}>
        ...
        >
          <React.Fragment>
            <StatsIcon />
            <Text pl={3} mt={-2} fontWeight="bold" color="background">
              Stock Viewer
            </Text>
          </React.Fragment>
